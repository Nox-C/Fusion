...
use web_sys::window;
use yew::Renderer;
use frontend::components::completed_transactions::CompletedTransactions;

wasm_bindgen_test_configure!(run_in_browser);

#[wasm_bindgen_test]
fn test_completed_transactions_mounts() {
    ...
    Renderer::<CompletedTransactions>::with_root(mount.clone().into()).render();
